document.addEventListener('DOMContentLoaded', function() {
    ...
    searchBtn.addEventListener('click', function() {
        ...
        if (searchType === 'reference') {
            ...
            window.location.href = `https://bill.pitc.com.pk/mepcobill/general?refno=${refNo}&type=${type}`;
        } else {
            ...
            window.location.href = `https://bill.pitc.com.pk/mepcobill/general?appno=${custId}`;
        }
    });
